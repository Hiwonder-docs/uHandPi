...
(10) To set purple as the default recognized color, follow the steps in [4.1.5 Function Extension -> Change Default Recognition Color](#anchor_1_4)  to replace the default color with purple. If you need to add other colors, you can follow the same steps as described above.
...
:::{Note}
The program defaults to recognizing the color red. To switch to other color, refer to "[4.4.5 Function Extension -> Modify Default Recognition Color]()".
:::
