...
### 1.4 Function Extension

<p id="anchor_1_4_1"></p>

**1.4.1 Change Default Recognition Color**
...
(10) To set purple as the default recognized color, follow the steps in [1.4 Function Extension]() to replace the default color with purple. If you need to add other colors, you can follow the same steps as described above.
...
**1.5.3 Display the Transmitted Image**
...
(2) Click the icon<img class="common_img" src="../_static/media/8.ai_visual_gameplay_course/2.1/image3.png"  />in the upper left corner of the desktop, or press “Ctrl+Alt+T” to open LX terminal.
...
**2.4.2 Change default recognized color**
...
(7) Input command “python3 color_classification.py” again and press Enter to start recognizing green. And the hand will rotate to the right.
...
In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to “[2.5.1 Import Parameter Module]()”.
...
(2) Click the icon<img class="common_img" src="../_static/media/8.ai_visual_gameplay_course/4.1/image2.png"  />in the upper left corner of the desktop, or press “Ctrl+Alt+T” to open LX terminal.
...
:::{Note}
The program defaults to recognizing the color red. To switch to other color, refer to “4.2 Modify Default Recognition Color”.
:::
...
**4.4.2 Change default recognized color**
...
(7) Input command “python3 color_tracking.py” again and press Enter to open the game.

```commandline
python3 color_tracking.py
```

### 4.5 Programming Analysis
...
**4.5.3 Program logic and related code analysis**

**(1) Initialization**

**①  Import function library**

In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to “[4.5.1 Import parameter module]()”.
...
**5.4.3 Program logic and related code analysis**

**(1) Initialization**

**① Import function library**

In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to “[5.4.1 Import Parameter Module]()”.
...
**6.4.1 Importing Parameter Modules**
...
**6.4.3 Program Logic and Code Analysis**
...
Second Parameter: cv2.COLOR_BGR2GRAY specifies the conversion type, in this case, converting from BGR to grayscale.
...
First Parameter: `"0.02"` specifies the duration of the action, measured in seconds.  

Second Parameter: `"[[6, servo_6]]"` indicates that servo 6 will rotate by `servo_6` pulse width units.  

## 7. Scissors-Rock-Paper
...
In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to “[7.4.1 Import parameter module]()”.
...
In this initialization step, the first task is to import the required libraries for subsequent program calls. For details on the imports, refer to “[8.4.1 Import parameter module]()”.
