...
(10) To set purple as the default recognized color, follow the steps in [1.4 Function Extension](#anchor_1_4) to replace the default color with purple. If you need to add other colors, you can follow the same steps as described above.
